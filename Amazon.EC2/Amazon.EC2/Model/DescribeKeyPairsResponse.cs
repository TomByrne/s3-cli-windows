...
namespace Amazon.EC2.Model
{
    ...
    public class DescribeKeyPairsResponse
    {
        ...
        /// </summary>
        /// <param name="describeKeyPairsResult">DescribeKeyPairsResult property</param>
        /// <returns>this instance</returns>
        ...
        public String ToXML() {
            ...
            xml.Append("<DescribeKeyPairsResponse xmlns=\"http://ec2.amazonaws.com/doc/2008-12-01/\">");
            ...
            if (IsSetDescribeKeyPairsResult()) {
                DescribeKeyPairsResult  describeKeyPairsResult = this.DescribeKeyPairsResult;

...
namespace Amazon.EC2.Model
{
    ...
    public class RegisterImageResponse
    {
        ...
        /// </summary>
        /// <param name="registerImageResult">RegisterImageResult property</param>
        /// <returns>this instance</returns>
        ...
        public String ToXML() {
            ...
            xml.Append("<RegisterImageResponse xmlns=\"http://ec2.amazonaws.com/doc/2008-12-01/\">");
            ...
            if (IsSetRegisterImageResult()) {
                RegisterImageResult  registerImageResult = this.RegisterImageResult;

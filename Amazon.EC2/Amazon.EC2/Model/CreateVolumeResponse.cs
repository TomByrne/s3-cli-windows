...
namespace Amazon.EC2.Model
{
    ...
    public class CreateVolumeResponse
    {
        ...
        /// <summary>
        /// Sets the CreateVolumeResult property
        /// </summary>
        /// <param name="createVolumeResult">CreateVolumeResult property</param>
        /// <returns>this instance</returns>
        public CreateVolumeResponse WithCreateVolumeResult(CreateVolumeResult createVolumeResult)
        {
        ...
        /// <returns>this instance</returns>
        public CreateVolumeResponse WithResponseMetadata(ResponseMetadata responseMetadata)
        {
        ...
        public String ToXML() {
            ...
            xml.Append("<CreateVolumeResponse xmlns=\"http://ec2.amazonaws.com/doc/2008-12-01/\">");
            if (IsSetCreateVolumeResult()) {
                CreateVolumeResult  createVolumeResult = this.CreateVolumeResult;

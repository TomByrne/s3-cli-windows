...
namespace Amazon.EC2.Model
{
    ...
    public class DescribeAddressesResponse
    {
        ...
        /// </summary>
        /// <param name="describeAddressesResult">DescribeAddressesResult property</param>
        /// <returns>this instance</returns>
        ...
        public String ToXML() {
            ...
            xml.Append("<DescribeAddressesResponse xmlns=\"http://ec2.amazonaws.com/doc/2008-12-01/\">");
            ...
            if (IsSetDescribeAddressesResult()) {
                DescribeAddressesResult  describeAddressesResult = this.DescribeAddressesResult;

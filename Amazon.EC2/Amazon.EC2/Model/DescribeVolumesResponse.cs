...
namespace Amazon.EC2.Model
{
    ...
    public class DescribeVolumesResponse
    {
        ...
        /// </summary>
        /// <param name="describeVolumesResult">DescribeVolumesResult property</param>
        ...
        public String ToXML() {
            ...
            xml.Append("<DescribeVolumesResponse xmlns=\"http://ec2.amazonaws.com/doc/2008-12-01/\">");
            if (IsSetDescribeVolumesResult()) {
                DescribeVolumesResult  describeVolumesResult = this.DescribeVolumesResult;

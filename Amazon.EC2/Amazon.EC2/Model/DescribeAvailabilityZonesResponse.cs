...
namespace Amazon.EC2.Model
{
    ...
    public class DescribeAvailabilityZonesResponse
    {
        ...
        /// </summary>
        /// <param name="describeAvailabilityZonesResult">DescribeAvailabilityZonesResult property</param>
        /// <returns>this instance</returns>
        ...
        public String ToXML() {
            ...
            xml.Append("<DescribeAvailabilityZonesResponse xmlns=\"http://ec2.amazonaws.com/doc/2008-12-01/\">");
            ...
            if (IsSetDescribeAvailabilityZonesResult()) {
                DescribeAvailabilityZonesResult  describeAvailabilityZonesResult = this.DescribeAvailabilityZonesResult;

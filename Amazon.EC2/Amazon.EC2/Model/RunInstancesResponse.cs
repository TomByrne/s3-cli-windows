...
namespace Amazon.EC2.Model
{
    ...
    public class RunInstancesResponse
    {
        ...
        /// </summary>
        /// <param name="runInstancesResult">RunInstancesResult property</param>
        /// <returns>this instance</returns>
        ...
        public String ToXML() {
            ...
            xml.Append("<RunInstancesResponse xmlns=\"http://ec2.amazonaws.com/doc/2008-12-01/\">");
            ...
            if (IsSetRunInstancesResult()) {
                RunInstancesResult  runInstancesResult = this.RunInstancesResult;
